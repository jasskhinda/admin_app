...
export function AdminAuthProvider({ children }) {
    ...
    // Sign in function
    const signInWithAdminRole = async(email, password) => {
        try {
            ...
            if (data?.user) {
                ...
                if (!profile) {
                    ...
                    return { ...data, warning: 'Profile not found' };
                }
            ...
            console.error('Error in signInWithAdminRole:', err);
    ...
    const value = {
        ...
        userProfile,
        loading,
        signIn: (email, password) => signInWithAdminRole(email, password),
