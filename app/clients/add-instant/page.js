...
export default function AddClientInstant() {
  ...
  // Load facilities on component mount - no auth check needed since middleware verified
  useEffect(() => {
    const loadFacilities = async () => {
      try {
        ...
        console.log('Could not load facilities via API');
      }
    };
