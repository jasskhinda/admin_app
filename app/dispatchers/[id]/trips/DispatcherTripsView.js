...
function getClientDetails(trip) {
  ...
  // Check if this is a facility trip
  if (trip.facility_id) {
...
export default function DispatcherTripsView({ user, userProfile, dispatcher, trips }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="mt-6">
            <h1 className="text-3xl font-bold text-gray-900">Trips for {getFullName()}</h1>
            <p className="mt-2 text-gray-600">Complete trip history and management</p>
          </div>
        </div>
              ...
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  {searchTerm || statusFilter !== 'all' 
                    ...
                    : 'This dispatcher has not been assigned any trips yet.'}
                </p>
              </div>
            )}
          </div>
